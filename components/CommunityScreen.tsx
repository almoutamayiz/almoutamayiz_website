...
const CommunityScreen: React.FC<{ user: User }> = ({ user }) => {
    ...
    if (selectedSubject) {
        return createPortal(
            <div className="fixed top-0 left-0 right-0 bottom-16 sm:bottom-20 z-[60] bg-black flex flex-col animate-fadeIn overflow-hidden">
                <div className="h-16 bg-neutral-900 border-b border-white/10 px-4 flex items-center gap-4 shrink-0">
                ...
                <div className="bg-neutral-900 border-t border-white/10 p-3 shrink-0 pb-safe">
    ...
    return (
        <div className="h-full bg-black flex flex-col font-cairo overflow-hidden">
            <div className="bg-neutral-900 border-b border-white/5 h-14 flex items-center justify-around px-4 shrink-0">
                {[
                            ...
                            {ALL_SUBJECTS_LIST.map((sub) => {
                                ...
                                return (
                                    <div 
                                        ...
                                        className="bg-neutral-900 border border-white/5 shadow-xl hover:border-brand/30 active:scale-[0.97] transition-all duration-300 cursor-pointer aspect-square rounded-[2rem] flex flex-col items-center justify-center gap-2 text-center overflow-hidden relative group"
                                    >
