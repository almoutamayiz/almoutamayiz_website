    ...
    <div className="fixed inset-0 z-50 bg-[#020202] font-cairo overflow-y-auto overflow-x-hidden custom-scrollbar touch-pan-y">
      ...
      <div className="relative z-10 w-full min-h-full flex flex-col items-center justify-start px-4 sm:px-6">
        ...
        <div className="w-full max-w-md flex flex-col gap-8 pb-10">
            ...
            {/* Auth Card */}
            <div className="w-full bg-neutral-900 border border-white/5 rounded-[2.5rem] p-6 shadow-2xl relative overflow-hidden group">
            ...
            <div className="w-full space-y-4 animate-slideUp relative z-10">
                ...
                <div className="w-full bg-neutral-900 border border-white/5 rounded-[2.5rem] p-4 shadow-2xl relative overflow-hidden">
            ...
            <div className="w-full space-y-6 pt-4 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                    {features.map((f, i) => (
                        <div key={i} className="bg-neutral-900 border border-white/5 p-5 rounded-2xl flex flex-col items-center gap-3 text-center shadow-lg group hover:border-brand/20 transition-all duration-500">
            ...
            <footer className="w-full mt-6 pt-10 border-t border-white/5 flex flex-col items-center gap-6 pb-6 relative z-10">
                <div className="bg-white/5 px-6 py-3 rounded-full border border-white/5 shadow-xl">
