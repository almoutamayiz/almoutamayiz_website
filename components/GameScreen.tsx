  ...
  return (
    <div className="h-screen w-full bg-[#020617] text-white flex flex-col font-cairo overflow-hidden relative">
      ...
      <div 
            ...
            className="fixed z-[120] flex items-center bg-neutral-900 border border-white/10 p-1 rounded-full shadow-lg cursor-move select-none opacity-60 hover:opacity-100 transition-opacity"
      ...
      <header className="p-4 flex justify-between items-center z-20 bg-neutral-900 border-b border-white/5 shrink-0">
      ...
      <aside className={`fixed top-0 left-0 h-full w-72 bg-[#020617] border-r border-white/10 z-50 transition-transform duration-500 flex flex-col ${showLadder ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      {activeLifeline === 'audience' && (
          <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 p-4 animate-fadeIn">
