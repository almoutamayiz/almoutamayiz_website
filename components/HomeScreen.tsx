...
const HomeScreen: React.FC<HomeScreenProps> = ({ user, curriculum, onUpdateUser }) => {
  ...
  if (activeTool) {
      return (
          <div className="p-4 sm:p-6 pb-24 animate-fadeIn min-h-screen">
              <button onClick={() => { setActiveTool(null); playClickSound(); }} className="mb-6 flex items-center gap-2 px-6 py-2 bg-white/5 rounded-full border border-white/10 text-sm font-bold text-white transition-all active:scale-95 shadow-lg mx-auto block">
  ...
  return (
    <div className="p-4 sm:p-6 pb-24 space-y-8 max-w-4xl mx-auto flex flex-col items-center">
      <section className="w-full transform-gpu">
        <div className="w-full rounded-[2.5rem] p-8 text-center relative overflow-hidden border border-white/5 bg-neutral-900 shadow-2xl min-h-[160px] flex flex-col justify-center transition-all duration-700">
      ...
      <section className="w-full optimize-scrolling" style={{ contentVisibility: 'auto' }}>
        <div className="w-full bg-neutral-900 border border-white/10 rounded-[2.5rem] p-8 text-center relative overflow-hidden shadow-2xl">
      ...
      <section className="w-full text-center optimize-scrolling" style={{ contentVisibility: 'auto' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div onClick={() => { setActiveTool('parser'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-neutral-900 border border-white/10 hover:border-blue-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('rhetoric'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-neutral-900 border border-white/10 hover:border-emerald-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('corrector'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-neutral-900 border border-white/10 hover:border-brand/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
            ...
            <div onClick={() => { setActiveTool('builder'); playClickSound(); }} className="group relative overflow-hidden rounded-[2rem] p-6 shadow-xl bg-neutral-900 border border-white/10 hover:border-purple-500/50 transition-all flex flex-col items-center justify-center cursor-pointer h-40 active:scale-95 text-center">
      ...
      <section className="w-full optimize-scrolling" style={{ contentVisibility: 'auto' }}>
         ...
         <div className="bg-neutral-900 rounded-[2rem] border border-white/5 p-6 shadow-2xl">
      ...
      <section className="w-full optimize-scrolling" style={{ contentVisibility: 'auto' }}>
        <div className="w-full bg-neutral-900 rounded-[2rem] p-8 border border-white/10 mt-4 shadow-xl text-center">
