  ...
  return (
    <div className="flex h-screen bg-black text-white font-cairo overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-black shadow-inner border-r border-white/5">
          <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-neutral-900 shrink-0">
          ...
          <div className="flex-1 overflow-y-auto p-6 sm:p-10 custom-scrollbar pb-40 relative bg-black min-h-screen">
              ...
              {activeTab === 'lessons' && (
                  <div className="animate-fadeIn space-y-8">
                      <div className="bg-neutral-900 p-6 rounded-[2rem] border border-white/5 grid grid-cols-1 md:grid-cols-3 gap-4 shadow-xl">
                      ...
                      {loading ? <div className="py-20 text-center"><Loader2 className="animate-spin text-brand mx-auto" size={40}/></div> : lessons.length === 0 ? <div className="py-20 text-center opacity-20"><Database size={64} className="mx-auto mb-4"/><p className="font-black text-xs uppercase tracking-widest">لا توجد دروس في هذا القسم حالياً</p></div> : (
                          <div className="space-y-3 max-w-4xl mx-auto">
                              {lessons.map((l, idx) => (
                                  <div key={l.id} className="bg-neutral-900 p-4 rounded-2xl border border-white/5 flex items-center gap-4 group hover:border-brand/30 transition-all">
              ...
              {activeTab === 'add_lesson' && (
                  <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
                      <div className="bg-neutral-900 p-8 rounded-[2.5rem] border border-white/5 space-y-6 shadow-2xl relative overflow-hidden">
              ...
              {activeTab === 'exams' && (
                  <div className="max-w-4xl mx-auto space-y-6 animate-fadeIn">
                      ...
                      {showExamForm && (
                          <div className="bg-neutral-900 p-8 rounded-[2.5rem] border border-white/10 space-y-4 mb-8 shadow-2xl">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {exams.map(ex => (
                              <div key={ex.id} className="bg-neutral-900 p-5 rounded-3xl border border-white/5 flex items-center justify-between">
              ...
              {activeTab === 'inbox' && (
                  <div className="max-w-4xl mx-auto space-y-6 animate-fadeIn">
                      <div className="flex bg-neutral-900 p-2 rounded-2xl border border-white/5 mb-8">
                      ...
                      <div className="space-y-4">
                          {messages.filter(m => { 
                              ...
                              return (
                                  <div key={msg.id} className={`bg-neutral-900 p-6 rounded-[2.5rem] border transition-all ${msg.is_replied ? 'border-white/5 opacity-60' : 'border-brand/20 shadow-xl'}`}>
              ...
              {activeTab === 'notifications' && (
                  <div className="max-w-3xl mx-auto space-y-6 animate-fadeIn">
                      <div className="bg-neutral-900 p-8 rounded-[2.5rem] border border-white/5 space-y-4 shadow-2xl mb-10">
              ...
              {activeTab === 'curriculum' && (
                  <div className="max-w-4xl mx-auto space-y-6 animate-fadeIn">
                      <div className="bg-neutral-900 p-8 rounded-[2.5rem] border border-white/5 shadow-2xl overflow-hidden">
              ...
              {activeTab === 'platform_guide' && (
                  <div className="max-w-4xl mx-auto space-y-10 animate-fadeIn">
                      <div className="flex bg-neutral-900 p-2 rounded-2xl border border-white/5 mb-8 sticky top-0 z-10">
                      ...
                      {guideSubTab === 'admin' ? (
                          <div className="space-y-12 pb-20">
                              ...
                              <div className="grid gap-8">
                                  <div className="bg-neutral-900 p-8 rounded-[3rem] border border-white/5 space-y-6 relative overflow-hidden group">
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                      <div className="bg-neutral-900 p-8 rounded-[3rem] border border-white/5 space-y-4">
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="grid gap-4">
                                  {TECHNICAL_QUESTIONS.map((item, idx) => (
                                      <div key={idx} className="bg-neutral-900 p-6 rounded-[2rem] border border-white/5 group hover:border-fuchsia-500/30 transition-all">
